...
var Router = class {
  ...
  on(path, handler) {
    if ((typeof path === "string" && path.length > 0 || typeof path === "number") && typeof handler === "function") {
  ...
  #matchRoute(path) {
    const routes = Object.keys(this.routes).filter((r) => r.includes(":") && r.split("/").length === path.split("/").length).map((r) => {
      return {
        route: r,
  ...
  listen() {
    navigation.addEventListener("navigate", (e) => {
      ...
      const param = /* @__PURE__ */ Object.create(null);
